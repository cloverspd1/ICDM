namespace BEL.ItemCodeCreationPreProcess.Models.Master
{
    ...
    /// <summary>
    /// Type Of Packaging Master
    /// </summary>
    /// <seealso cref="BEL.CommonDataContract.IMaster" />
    [DataContract, Serializable]
    public class TypeOfPackagingMaster : IMaster
    {
        /// <summary>
        ...
        {
            get { return Masters.TYPEOFPACKAGINGMASTER; }
            set { }
        }
        ...
        {
            get { return typeof(TypeOfPackagingMasterListItem); }
            set { }
        }
    }
}