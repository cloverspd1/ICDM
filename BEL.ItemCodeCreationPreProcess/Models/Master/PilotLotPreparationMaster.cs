namespace BEL.ItemCodeCreationPreProcess.Models.Master
{
    ...
    /// <summary>
    /// Pilot Lot Preparation Master
    /// </summary>
    /// <seealso cref="BEL.CommonDataContract.IMaster" />
    [DataContract, Serializable]
    public class PilotLotPreparationMaster : IMaster
    {
        /// <summary>
        ...
        {
            get { return Masters.PILOTLOTPREPARATIONMASTER; }
            set { }
        }
        ...
        {
            get { return typeof(PilotLotPreparationMasterListItem); }
            set { }
        }
    }
}