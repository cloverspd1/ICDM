namespace BEL.ItemCodeCreationPreProcess.Models.ItemCode
{
    ...
    /// <summary>
    /// Costing Delegate1 Section
    /// </summary>
    [DataContract, Serializable]
    public class CostingDelegate1Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostingDelegate1Section"/> class.
        /// </summary>
        public CostingDelegate1Section()
        {
        }
        ...
        public CostingDelegate1Section(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(ICCPListNames.ICCPMAINLIST, true) };
                this.SectionName = ICCPSectionName.COSTINGDELEGATE1SECTION;
