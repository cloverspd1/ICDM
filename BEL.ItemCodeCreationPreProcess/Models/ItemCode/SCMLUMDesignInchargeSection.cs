namespace BEL.ItemCodeCreationPreProcess.Models.ItemCode
{
    ...
    /// <summary>
    /// SCMLUMDesign Incharge Section
    /// </summary>
    [DataContract, Serializable]
    public class SCMLUMDesignInchargeSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCMLUMDesignInchargeSection"/> class.
        /// </summary>
        public SCMLUMDesignInchargeSection()
        {
        }
        ...
        public SCMLUMDesignInchargeSection(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(ICCPListNames.ICCPMAINLIST, true) };
                this.SectionName = ICCPSectionName.SCMLUMDESIGNINCHARGESECTION;
        ...
        /// <summary>
        /// Gets or sets the scmlum design delegate.
        /// </summary>
        /// <value>
        /// The scmlum design delegate.
        /// </value>
        [DataMember, IsPerson(true, true, returnId: true), RequiredOnDelegate, IsViewer]
        public string SCMLUMDesignDelegate { get; set; }

        /// <summary>
        /// Gets or sets the name of the scmlum design delegate.
        /// </summary>
        /// <value>
        /// The name of the scmlum design delegate.
        /// </value>
        [DataMember, IsPerson(true, true, returnName: true), FieldColumnName("SCMLUMDesignDelegate"), IsViewer]
        public string SCMLUMDesignDelegateName { get; set; }
        ...
        public bool IsSubmitted
        {
            get
            {
                if (this.ApproversList.Any(p => p.Role == ICCPRoles.SCMLUMDESIGNDELEGATE && string.IsNullOrEmpty(p.Approver)))
                {
                    return true;
                }
                return false;
