namespace BEL.ItemCodeCreationPreProcess.Models.ItemCode
{
    ...
    /// <summary>
    /// SMS Delegate Section
    /// </summary>
    [DataContract, Serializable]
    public class SMSDelegateSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SMSDelegateSection"/> class.
        /// </summary>
        public SMSDelegateSection()
        {
        }
